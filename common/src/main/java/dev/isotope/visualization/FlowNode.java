...
public final class FlowNode {
    ...
    private FlowNode(ResourceLocation id, NodeType type, String displayName, @Nullable LootSourceType sourceType) {
        this.id = id;
        this.type = type;
     ...
     */
    public static FlowNode source(ResourceLocation id, String name, LootSourceType sourceType) {
     ...
     */
    public static FlowNode lootTable(ResourceLocation id, String name) {
     ...
     */
    public static FlowNode nestedTable(ResourceLocation id, String name) {
