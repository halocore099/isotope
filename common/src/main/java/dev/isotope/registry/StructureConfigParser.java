...
public final class StructureConfigParser {
    ...
    private final Map<ResourceLocation, ResourceLocation> structureToStartPool = new LinkedHashMap<>();
    ...
    private final Map<ResourceLocation, String> structureTypes = new LinkedHashMap<>();
     ...
     */
    private void parseStructureJson(ResourceLocation path, Resource resource) {
        try (BufferedReader reader = new BufferedReader(
            ...
            ResourceLocation structureId = extractStructureId(path);
     ...
     */
    private void parseJigsawStructure(JsonObject json, ResourceLocation structureId, Set<ResourceLocation> foundLoot) {
     ...
     */
    private void parseStructureTypeLoot(String type, JsonObject json, ResourceLocation structureId,
                                         Set<ResourceLocation> foundLoot) {
        switch (type) {
     ...
     */
    private ResourceLocation extractStructureId(ResourceLocation path) {
     ...
     */
    public Optional<ResourceLocation> getStartPoolForStructure(ResourceLocation structureId) {
     ...
     */
    public Set<ResourceLocation> getLootTablesForStructure(ResourceLocation structureId) {
     ...
     */
    public Optional<String> getStructureType(ResourceLocation structureId) {
     ...
     */
    public Map<ResourceLocation, Set<ResourceLocation>> buildStructureLootMap() {
     ...
     */
    public Map<ResourceLocation, ResourceLocation> getJigsawStartPools() {
     ...
     */
    public boolean isJigsawStructure(ResourceLocation structureId) {
