...
public record LootEntry(
    ...
    Optional<Id> name,                     // Item ID for item entries, table ID for loot_table entries
     ...
     */
    public static LootEntry item(Id itemId) {
     ...
     */
    public static LootEntry item(Id itemId, int weight) {
     ...
     */
    public static LootEntry item(Id itemId, int weight, int minCount, int maxCount) {
     ...
     */
    public static LootEntry lootTable(Id tableId, int weight) {
        return new LootEntry(
            TYPE_LOOT_TABLE,
            Optional.of(tableId),
            weight,
     ...
     */
    public LootEntry withItem(Id newItem) {
     ...
     */
    public LootEntry withType(String newType, Optional<Id> newName) {
