...
public final class LootObserver {
    ...
    private final Map<Id, List<LootInvocation>> invocationsByTable = new ConcurrentHashMap<>();
    ...
    private final Map<Id, List<LootAssignment>> assignmentsByTable = new ConcurrentHashMap<>();
    ...
    public record LootAssignment(
         ...
         */
        public Optional<Id> inferStructureId() {
            ...
            if (classRegistry.isScanned()) {
                Optional<Id> exact = classRegistry.getStructureForClass(className);
                if (exact.isPresent()) {
                    return exact;
                }
            }
            ...
            if (lowerOrigin.contains("village")) {
                return Optional.of(Id.of(callerNamespace, "village"));
            }
            if (lowerOrigin.contains("stronghold")) {
                return Optional.of(Id.of(callerNamespace, "stronghold"));
            }
            if (lowerOrigin.contains("mineshaft")) {
                return Optional.of(Id.of(callerNamespace, "mineshaft"));
            }
            if (lowerOrigin.contains("dungeon") || lowerOrigin.contains("monster_room")) {
                return Optional.of(Id.of(callerNamespace, "monster_room"));
            }
            if (lowerOrigin.contains("shipwreck")) {
                return Optional.of(Id.of(callerNamespace, "shipwreck"));
            }
            if (lowerOrigin.contains("ocean_ruin")) {
                return Optional.of(Id.of(callerNamespace, "ocean_ruin"));
            }
            if (lowerOrigin.contains("buried_treasure")) {
                return Optional.of(Id.of(callerNamespace, "buried_treasure"));
            }
            if (lowerOrigin.contains("end_city")) {
                return Optional.of(Id.of(callerNamespace, "end_city"));
            }
            if (lowerOrigin.contains("bastion")) {
                return Optional.of(Id.of(callerNamespace, "bastion_remnant"));
            }
            if (lowerOrigin.contains("fortress") || lowerOrigin.contains("nether_bridge")) {
                return Optional.of(Id.of(callerNamespace, "fortress"));
            }
            if (lowerOrigin.contains("ruined_portal")) {
                return Optional.of(Id.of(callerNamespace, "ruined_portal"));
            }
            if (lowerOrigin.contains("desert_pyramid")) {
                return Optional.of(Id.of(callerNamespace, "desert_pyramid"));
            }
            if (lowerOrigin.contains("jungle") && (lowerOrigin.contains("temple") || lowerOrigin.contains("pyramid"))) {
                return Optional.of(Id.of(callerNamespace, "jungle_pyramid"));
            }
            if (lowerOrigin.contains("igloo")) {
                return Optional.of(Id.of(callerNamespace, "igloo"));
            }
            if (lowerOrigin.contains("pillager") || lowerOrigin.contains("outpost")) {
                return Optional.of(Id.of(callerNamespace, "pillager_outpost"));
            }
            if (lowerOrigin.contains("woodland") || lowerOrigin.contains("mansion")) {
                return Optional.of(Id.of(callerNamespace, "woodland_mansion"));
            }
            if (lowerOrigin.contains("ancient_city")) {
                return Optional.of(Id.of(callerNamespace, "ancient_city"));
            }
            if (lowerOrigin.contains("trial_chamber")) {
                return Optional.of(Id.of(callerNamespace, "trial_chambers"));
            }
            ...
            if (!callerNamespace.equals("minecraft")) {
                ...
                if (structureName != null) {
                    return Optional.of(Id.of(callerNamespace, structureName));
                }
            }
     ...
     */
    public List<LootInvocation> getInvocationsOf(Id tableId) {
     ...
     */
    public Set<Id> getObservedTables() {
     ...
     */
    public void onLootAssigned(Id tableId, String callerOrigin, BlockPos pos) {
        if (!recording.get()) return;
     ...
     */
    public List<LootAssignment> getAssignmentsFor(Id tableId) {
     ...
     */
    public Map<Id, Set<Id>> buildAssignmentLinks() {
