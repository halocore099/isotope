...
public final class ObservationSession {
    ...
    public SessionResult runSession(MinecraftServer server, Consumer<String> onProgress) {
        ...
        try {
            ...
            Map<Id, StructurePlacementEngine.PlacementResult> placementResults =
     ...
     */
    public Optional<ObservedStructureData> getStructureData(Id structureId) {
    ...
    public record ObservedStructureData(
        Id structureId,
        Set<Id> lootTables,
        Set<Id> observedItems,
        Map<Id, Integer> invocationCounts,
